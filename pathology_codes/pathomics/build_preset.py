...
parser = argparse.ArgumentParser(description='Build a pathology tissue-processing preset')
parser.add_argument('--output-file', type=Path, required=True,
					help='destination CSV for the preset')
...
if __name__ == '__main__':
	...
	params_df.to_csv(args.output_file, index=False)
